    ...
    return (
        <section className=' min-h-[900px] relative' style={{ backgroundImage: `url(/${backgrounds[currBg]}.jpg)`, backgroundSize: 'cover' }}>
            <div className='absolute top-0 left-0 bg-[#0000005a]  h-full w-full'>
                <div className='w-full max-w-max mx-auto pt-60 flex flex-col items-end'>
                    ...
                    <h1 className='mt-10 text-[75px] max-w-[70%] font-semibold text-white tracking-[2px] leading-[80px] text-right'>
                        We Provide The Best Investment Solutions
                    </h1>
                    <p className='text-2xl text-white max-w-[50%] mt-10 font-light text-right'>
                        We are a
                    ...
                    <div className='flex gap-10 mt-12 '>
                        <button className='px-3 py-4 bg-primaryBlue rounded-full w-[160px] text-white text-base border-white hover:border-primaryBlue border hover:bg-white hover:text-primaryBlue'>EXPLORE</button>
                        <button className='px-3 py-4 border border-white hover:bg-primaryBlue rounded-full w-[160px] text-white text-base'>GET IN TOUCH</button>
                    </div>
                </div>
            </div>
        </section>
